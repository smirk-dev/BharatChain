...
title 🇮🇳 BharatChain Platform Launcher 🇮🇳setlocal enabledelayedexpansionsetlocal enabledelayedexpansion



REM ============================================================================title 🇮🇳 BharatChain Platform Launcher 🇮🇳title 🇮🇳 BharatChain Platform Launcher 🇮🇳
...
REM All services will be automatically configured and launchedREM ============================================================================REM ============================================================================

REM Browser will open automatically when ready

REM ============================================================================REM 🇮🇳 BharatChain Digital Identity Platform - One-Click Startup 🇮🇳REM 🇮🇳 BharatChain Digital Identity Platform - One-Click Startup 🇮🇳
...
echo  ║  ████████╗██████╗  ██╗  ██╗ █████╗ ██████╗  █████╗ ████████╗███████╗ ║REM All services will be automatically configured and launchedREM All services will be automatically configured and launched

echo  ║  ██╔══██║██╔══██╗ ██║  ██║██╔══██╗██╔══██╗██╔══██╗╚══██╔══╝██╔════╝ ║

echo  ║  ██████╔╝██████╔╝ ███████║███████║██████╔╝███████║   ██║   ███████╗ ║REM Browser will open automatically when readyREM ============================================================================
...
set "PYTHON_PATH=%PROJECT_ROOT%.venv\Scripts\python.exe"echo  ║  ██╔══██║██╔══██╗ ██║  ██║██╔══██╗██╔══██╗██╔══██╗╚══██╔══╝██╔════╝ ║echo  ║  ██████╔╝██████╔╝ ███████║███████║██████╔╝███████║   ██║   ███████╗ ║
...
echo ║                        Validating System Requirements                   ║echo  ║  ██████╔╝██║  ██║ ██║  ██║██║  ██║██║  ██║██║  ██║   ██║   ███████║ ║echo  ║  ╚═════╝ ╚═╝  ╚═╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚══════╝ ║
...
REM Check Node.jsecho  ║                                                                      ║echo  ║             🇮🇳 DIGITAL IDENTITY ^& GOVERNANCE PLATFORM 🇮🇳           ║

echo    🔍 Checking Node.js installation...

node --version >nul 2>&1echo  ║             🇮🇳 DIGITAL IDENTITY ^& GOVERNANCE PLATFORM 🇮🇳           ║echo  ║                                                                      ║
...
if %errorlevel% neq 0 (
    ...
    set /a ERROR_COUNT+=1echo  ║          🚀 INTELLIGENT ONE-CLICK STARTUP SYSTEM 🚀                  ║echo  ║                    ⚡ Everything Automated ⚡                       ║

) else (

    for /f "tokens=*" %%i in ('node --version') do set NODE_VERSION=%%iecho  ║                    ⚡ Everything Automated ⚡                       ║echo  ╚══════════════════════════════════════════════════════════════════════╝
...
REM Check Python (project virtual environment)echo.echo                     🌟 Empowering Digital India 🌟
...
if exist "%PYTHON_PATH%" (echo                     🌟 Empowering Digital India 🌟echo.
    ...
    python --version >nul 2>&1REM Set project root

    if %errorlevel% neq 0 (

        color 0CREM Set project rootset "PROJECT_ROOT=%~dp0"

        echo    ❌ Python not found - please install Python 3.8+ from python.org

        set /a ERROR_COUNT+=1set "PROJECT_ROOT=%~dp0"set "PYTHON_PATH=%PROJECT_ROOT%.venv\Scripts\python.exe"
